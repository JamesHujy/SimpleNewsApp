...
public abstract class BaseSearchAdapter <T> extends RecyclerView.Adapter<BaseSearchAdapter.BaseViewHolder>{
    protected List<T> datas;
    protected Context mContext;

    public BaseSearchAdapter(List<T> datas,Context mContext) {
        this.datas = datas;
    ...
    @Override
    public void onBindViewHolder(BaseSearchAdapter.BaseViewHolder holder, final int position) {
